...
class AnimatedSearch extends React.Component {
  state = {
    width: 0,
  ...
  open = () => {
    ...
    onOpening && onOpening()
    this.props.setSearchClicked && this.props.setSearchClicked(true)
    ...
    Animated.timing(this.state.parentViewWidthAnimated, {
      ...
      setTimeout(() => {
        Animated.timing(this.state.textInputAnimated, {
          ...
          onClosed && onClosed()
          this.props.setSearchClicked && this.props.setSearchClicked(false)
        })
      }, 125)
    })
  }
